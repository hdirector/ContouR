...
################################
#test perpen_pts and perpen_rot
###############################
w <- .02
...
horiz_pts <- perpen_pts(w, Cx, Cy, horiz_x, horiz_y)
...
vert_pts <- perpen_pts(w, Cx, Cy, vert_x, vert_y)
...
q1_pts <- perpen_pts(w, Cx, Cy, q1_x, q1_y)
...
q2_pts <- perpen_pts(w, Cx, Cy, q2_x, q2_y)
...
q3_pts <- perpen_pts(w, Cx, Cy, q3_x, q3_y)
...
q4_pts <- perpen_pts(w, Cx, Cy, q4_x, q4_y)
